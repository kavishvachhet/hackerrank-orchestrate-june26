"""
Image analysis module V2 — VLM calls via OpenRouter for damage claim review.
Uses improved prompts_v2 with severity rubric and chain-of-thought.
"""
import json
import time
import re
...
from openrouter_v2.prompts_v2 import (
    get_system_prompt,
