"""
Main orchestration pipeline V3 for OpenRouter Multi-Modal Evidence Review.
Uses improved prompts_v3, postprocessor_v3, and analyzer_v3.
...
from openrouter_v3.analyzer_v3 import (
    process_claim_strategy_a,
    get_token_usage,
)
from openrouter_v3.postprocessor_v3 import postprocess_result, format_output_row
...
def process_claims(
    ...
    print(f"\n{'='*60}")
    print(f"OpenRouter V3 Evidence Review (Anti-Hallucination Pipeline)")
    print(f"{'='*60}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run OpenRouter V3 Evidence Review")
    ...
    if args.mode == "sample":
        ...
        output_csv = DATASET_DIR / "output3.csv"
