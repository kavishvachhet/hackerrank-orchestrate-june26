"""
Image analysis module V3 — VLM calls via OpenRouter for damage claim review.
Uses improved prompts_v3 with all V3 fixes.
"""
import json
import time
import re
...
from openrouter_v3.prompts_v3 import (
    get_system_prompt,
